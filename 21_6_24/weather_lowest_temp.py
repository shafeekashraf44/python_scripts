        ...
        for entry in history_data:
            ...
            if temp is not None:
                if lowest_temp is None or temp < lowest_temp:
                    lowest_temp = temp
                    lowest_temp_timestamp = timestamp
        
        # Printing the results if lowest temperature is found
        if lowest_temp is not None:
            print(f"The lowest temperature was {lowest_temp}°C at {lowest_temp_timestamp}.")
        else:
